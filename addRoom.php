...
<div id="wrapper">
    ...
    if (isset($_POST['addld']))
    {
        ...
        $check = $st->addRoom($roomNo,$roomCapacity);
    }
            ...
            <div class="col-lg-8">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <form role="form" class="col-lg-12" method="post" action="addRoom.php">
                                 <div class="row">
                            ...
                            <div class="form-group">
                                <label>Room No:</label>
                                <input class="form-control"  required type="text" name="RoomNo"  placeholder="Enter Room No." />
                            </div>
                                <div class="form-group">
                                    <label>Room Capacity:</label>
                                    <input class="form-control"  required type="text" name="roomCapacity"  placeholder="Room Capacity" />
                                </div>
                            </div>
                            <div class="col-lg-8">
