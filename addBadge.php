            ...
            <div class="col-lg-8">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <form role="form" class="col-lg-12" method="post" action="addBadge.php">
                                 <div class="row">
                            ...
                            <div class="form-group">
                                <label>Badge:</label>
                                <input class="form-control"  required type="text" name="badge"  placeholder="Enter Padge" />
                            </div>
                            </div>
                            <div class="col-lg-8">
