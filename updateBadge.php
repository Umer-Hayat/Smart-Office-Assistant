...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Update Badge</h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <!-----New Row---->
                        ...
                        <form role="form" class="col-lg-12" method="post" action="">
                                 <div class="row">
                                     <div style="color:red; text-align: center; font-size:16px;"><?php
                                         ...
                                         $letter=$st->getAllRecord($id,'student_badge');
                            ...
                            <div class="form-group">
                                <label>Badge:</label>
                                <input class="form-control" value="<?php echo $value['badge']; ?>" required type="text" name="badge"  placeholder="Enter Padge" />
                            </div>
                            </div>
                            <div class="col-lg-8">
