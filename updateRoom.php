...
<div id="wrapper">
    ...
    if (isset($_POST['addld']))
    {
        ...
        $check = $st->updateRoom($roomNo,$roomCapacity,$id);
    }
                        ...
                        <form role="form" class="col-lg-12" method="post" action="">
                                 <div class="row">
                                     <div style="color:red; text-align: center; font-size:16px;"><?php
                                         ...
                                         $letter=$st->getAllRecord($id,'rooms');
                            ...
                            <div class="form-group">
                                <label>Room No:</label>
                                <input class="form-control"  value="<?php echo $value['roomNo']; ?>" readonly  required type="text" name="RoomNo"  placeholder="Enter Room No." />
                            </div>
                                <div class="form-group">
                                    <label>Room Capacity:</label>
                                    <input class="form-control"  value="<?php echo $value['roomCapacity']; ?>" required type="text" name="roomCapacity"  placeholder="Room Capacity" />
                                </div>
                            </div>
                            <div class="col-lg-8">
