...
<div id="wrapper">
    ...
    <?php
    include_once 'classes/TeacherManagement.php';
    $st=new TeacherManagement();
    $id=$_GET['print'];
    if (isset($_POST['addld']))
    {
        $teacher=$_POST['teacher'];
        $check = $st->teacherAllotment($teacher,$id);
    }
    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Teacher Allotment</h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <!-----New Row---->
                        ...
                        <form role="form" class="col-lg-12" method="post" action="">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" required name="teacher">
                                    ...
                                    <?php
                                    $query="select * from teacher where status='0'";
                                    $letter=$st->getRecordsBYQuery($query);
                                    if($letter)
                                    {
                            ...
                            <div class="col-lg-8">
                            <button type="submit" name="addld" class="btn btn-primary"><i class="fa fa-sign-out fa-fw"></i> Add Teacher</button>
