...
<div id="wrapper">
    ...
    if (isset($_POST['addld']))
    {
        $code=$_POST['code'];
        $title=$_POST['title'];
        $check = $st->updateCourse($code,$title,$id);
    }
                        ...
                        <form role="form" class="col-lg-12" method="post" action="">
                                 <div class="row">
                                     <div style="color:red; text-align: center; font-size:16px;"><?php
                                         ...
                                         $letter=$st->getAllRecord($id,'course');
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" value="<?php echo $value['course_code']; ?>" readonly required type="text" name="code"  placeholder="Enter Course Code" />
                            </div>
                                <div class="form-group">
                                    <label>Course Title:</label>
                                    <input class="form-control" value="<?php echo $value['course_title']; ?>"  required type="text" name="title"  placeholder="Enter Course Title" />
                                </div>
                            </div>
                            <div class="col-lg-8">
