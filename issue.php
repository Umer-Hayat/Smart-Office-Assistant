...
<div id="wrapper">
    ...
    if (isset($_POST['addld']))
    {
        ...
        $check = $st->issue($id,$date, $issue,$quantity);
    }
                        ...
                        <form role="form" class="col-lg-12" method="post" action="">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control"  required type="text" name="issue"  placeholder="Issue To" />
                                </div>
                                <div class="form-group">
                                    <label>Quantity:</label>
                                    <input class="form-control"  required type="number" name="quantity"  placeholder="Quantity" />
                                </div>
                            ...
                            <div class="col-lg-8">
                            <button type="submit" name="addld" class="btn btn-primary"><i class="fa fa-sign-out fa-fw"></i> Issue</button>
