            ...
            <div class="col-lg-8">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <form role="form" class="col-lg-12" method="post" action="addStationary.php">
                                 <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control"  required type="text" name="title"  placeholder="Stationary Title" />
                            </div>
                            </div>
                            <div class="col-lg-8">
