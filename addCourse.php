            ...
            <div class="col-lg-8">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <form role="form" class="col-lg-12" method="post" action="addCourse.php">
                                 <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control"  required type="text" name="code"  placeholder="Enter Course Code" />
                            </div>
                                <div class="form-group">
                                    <label>Course Title:</label>
                                    <input class="form-control"  required type="text" name="title"  placeholder="Enter Course Title" />
                                </div>
                            </div>
                            <div class="col-lg-8">
